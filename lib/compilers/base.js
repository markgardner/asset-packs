...
function BaseCompiler(opts) {
	...
	this.name = path.basename(opts.rootDir);
	this.fileContent = {};
	this.generatedContent = {};
	this.contentTypes = ['js'];
	this.autoWatch = opts.autoWatch;
	this.useStrict = opts.useStrict;

	this.pack.js = this.globFiles(this.pack.js, this.rootDir, 'js');
	this.pack.html = this.globFiles(this.pack.html, this.rootDir, 'js');
}
